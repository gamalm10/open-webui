                    ...
                    await __event_emitter__(
                        {
                            ...
                            "data": {
                                "status": "in_progress",
                                "description": "Sending request to assistant...",
                                "done": False,
                            },
                        }
                    )
...
{quoted_content}
                        ...
                        self.log.info(
                            "Processing regular response from Assistant (non-streaming)"
                        )
                        ...
                        if not n8n_response:
                            n8n_response = "(Received empty response or unknown format from Assistant)"
